...
_setupVars =
{
	_missionType = "Avant-Poste Ennemi";
...
_setupObjects =
{
	...
	_missionHintText = format ["Un <t color='%1'>avant-poste</t> armé contenant du matériel militaire à été repéré près du marqueur, allez le captuer !", sideMissionColor]
};
...
_successExec =
{
	...
	_successHintMessage = "L'avant-poste à été capturé, bien joué.";
};

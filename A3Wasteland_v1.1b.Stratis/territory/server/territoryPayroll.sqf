...
while {true} do
{
...

	{
		...
		_message =  format ["Votre équipe à reçu un bonus de $%1 pour avoir tenu %2 territoires %3 durant les %4 dérnièresminutes", [_money] call fn_numbersText, _count, if (_count == 1) then { "y" } else { "ies" }, ceil (_timeInterval / 60)];

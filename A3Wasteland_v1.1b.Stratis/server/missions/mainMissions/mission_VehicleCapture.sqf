...
_setupObjects =
{
	...
	_missionHintText = format ["%1 <t color='%3'>%2</t> à été immobilisé, récupérez le pour votre équipe !", _vehDeterminer, _vehicleName, mainMissionColor];
};
...
_successExec =
{
	...
	_successHintMessage = format ["Le %1 à été capturé, bien joué.", _vehicleName];
};

...
_playerMenuAction = [format ["<img image='client\icons\playerMenu.paa' color='%1'/> <t color='%1'>[</t>Menu joueur<t color='%1'>]</t>", "#FF8000"], "client\systems\playerMenu\init.sqf", [], -10, false]; //, false, "", ""];
